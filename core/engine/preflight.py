...
SCHEMA_ASSETS = (
    ...
    Path("schemas/autonomy_source_snapshot.schema.json"),
    Path("schemas/book_lease.schema.json"),
    Path("schemas/chapter_blueprint.schema.json"),
    Path("schemas/chapter_context_authority_migration.schema.json"),
    Path("schemas/chapter_context_read_set.schema.json"),
    Path("schemas/chapter_pipeline.schema.json"),
    Path("schemas/chapter_completion_receipt.schema.json"),
    ...
    Path("schemas/repair_envelope.schema.json"),
    ...
    Path("schemas/run_arc_plan.schema.json"),
    ...
    Path("schemas/stage_lease_fence.schema.json"),
    ...
    Path("schemas/trusted_profiles.schema.json"),
